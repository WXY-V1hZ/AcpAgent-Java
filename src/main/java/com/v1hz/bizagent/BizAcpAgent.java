...
import com.v1hz.bizagent.service.ChatService;
import com.v1hz.bizagent.service.SessionService;
...
public class BizAcpAgent {
    ...
    public BizAcpAgent(ChatService chatService, SessionService sessionService,
    ...
    public Mono<InitializeResponse> init(InitializeRequest request) {
        ...
        return Mono.just(new InitializeResponse(
                1, caps, null,
                new Implementation("BizAgent", "1.0.0", "业务智能助手"),
                null
        ));
    }
